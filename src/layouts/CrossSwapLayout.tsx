...
export const CrossSwapLayoutCard: FC<{ className?: string }> = ({ children, className }) => {
    return (
        <div
...
type CrossSwapLayout = (id: string) => FC

export const SwapLayout: CrossSwapLayout = (id: string) => {
